...
/**
 * @PreAuthorize("hasRole('ADMIN')") — double protection.
 * SecurityConfig already blocks non-admins at the URL level.
 * This annotation adds method-level protection as a second layer.
 */
@RestController
